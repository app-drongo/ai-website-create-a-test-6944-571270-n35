  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Testing Plans', href: '#pricing' },
        { name: 'Test Templates', href: '/templates' },
    ...
    },
    {
      title: 'Company',
      links: [
        { name: 'About TestLanding', href: '#about' },
        { name: 'Testing Blog', href: '/blog' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Testing Community', href: '/community' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Revolutionizing A/B testing and landing page optimization with advanced analytics.
                Join thousands of marketers who trust TestLanding for data-driven conversions.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (555) TEST-123</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">456 Analytics Blvd, Suite 200</span>
              </div>
            </div>

            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm">Testing Insights Weekly</h4>
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder="Enter your email for testing tips"
              ...
              <p className="text-xs text-muted-foreground">
                Get weekly A/B testing insights and conversion optimization tips. Unsubscribe
                anytime.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Made with <Heart className="size-3 text-red-500 fill-current" /> by our optimization
                team
              </span>
            </div>
