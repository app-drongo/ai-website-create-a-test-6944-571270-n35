        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              Launching TestLanding Beta Platform
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              The all-in-one platform for rapid prototyping, A/B testing, and deployment. From
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.8/5 early access rating</span>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground font-medium">TestLanding Dashboard</p>
                    <p className="text-sm text-muted-foreground/80 mt-1">Deploy • Test • Iterate</p>
                  </div>
                </div>
              </div>
